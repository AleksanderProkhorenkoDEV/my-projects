    ...
    return (
        <main className='w-full flex flex-col gap-8 pb-8'>
            <section className='w-full h-screen flex flex-col items-center justify-center gap-4 600k:mb-16'>
                <h1 className={`w-[75rem] uppercase text-7xl ${bebas.className} tracking-wider z-20 1k3:text-6xl 1k2:text-4xl 1k2:w-[65rem] 1k:text-2xl 1k:w-[55rem] 1k:absolute 1k:left-[40%] 1k:top-[30%] 1k:w-fit  600k:left-[36%] 500k:left-[33%] 400k:left-[27%] 300k:left-[24%] `}>{t('title')}</h1>
                ...
                <div className='hidden 1k:block 1k:w-full 1k:h-full 1k:relative m-auto'>
                    <Image
                        ...
                        height={250}
                        alt='logo aleksander'
                        className='absolute left-[35%] top-[40%]  rotate-horizontal 600k:left-[30%] 500k:left-[25%] 400k:left-[19%] 300k:left-[15%] 300k:top-[43%] wh-movile:top-[45%]' />
                    <Novatrix />
                </div>
                <p className={`w-[75rem] text-end uppercase text-xl ${montserrat.className} tracking-wider 1k3:text-lg 1k2:text-base 1k2:w-[65rem] 1k:w-[55rem]  1k:absolute 1k:w-fit 1k:left-[30%] 1k:top-[70%] 600k:left-[25%] 600k:top-[65%] 600k:text-sm 500k:left-[20%] 400k:left-[12%] 300k:left-[6%] wh-movile:top-[75%]`}>Aleksander Trujillo Prokhorenko</p>
