    ...
    return (
        <main className='w-full flex flex-col gap-8 pb-8'>
            <section className='w-full h-screen flex flex-col items-center justify-center gap-4'>
                <h1 className={`w-[75rem] uppercase text-7xl ${bebas.className} tracking-wider z-20 1k3:text-6xl 1k2:text-4xl 1k2:w-[65rem] 1k:text-2xl 1k:w-[55rem]`}>{t('title')}</h1>
                <div className='w-[80rem] h-1/2 1k3:w-[70rem] 1k2:w-[60rem] 1k:w-[45rem]'>
                    <Novatrix/>
                </div>
                <p className={`w-[75rem] text-end uppercase text-xl ${montserrat.className} tracking-wider 1k3:text-lg 1k2:text-base 1k2:w-[65rem] 1k:w-[55rem]`}>Aleksander Trujillo Prokhorenko</p>
